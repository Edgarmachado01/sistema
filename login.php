...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($sessionToken === '' || $postToken === '' || !hash_equals($sessionToken, $postToken)) {
        ...
        $slug = trim((string)($_POST['empresa'] ?? ''));
        ...
        if ($slug === '' || !filter_var($email, FILTER_VALIDATE_EMAIL) || $pass === '') {
            ...
            try {
                ...
                error_log('login.php autenticacao: '.$e->getMessage());
                $err = 'Nao foi possivel acessar com os dados informados.';
            }
        }
    }
...
<head>
    ...
    <title>Login - HelpDesk Facil</title>
        ...
        <div class="hf-login-card">
            <div class="hf-login-head">
                <div class="hf-logo-wrap">
                    <img src="/logo.png" alt="HelpDesk Facil" class="hf-login-logo">
                </div>
                <h1 class="hf-login-title">Entrar no painel</h1>
                ...
                <form method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="hf-input-icon">
                            ...
                            <input name="empresa" class="form-control" placeholder="Ex.: minha-empresa" autocomplete="organization" value="<?= htmlspecialchars($empresaInput, ENT_QUOTES, 'UTF-8') ?>" required>
                        </div>
                        <div class="hf-field-help">E o identificador da sua empresa no sistema, recebido no cadastro.</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="hf-input-icon">
                            ...
                            <input name="email" type="email" class="form-control" placeholder="voce@empresa.com" autocomplete="username" value="<?= htmlspecialchars($emailInput, ENT_QUOTES, 'UTF-8') ?>" required>
                        </div>
                        <div class="hf-field-help">Use o e-mail cadastrado para esse codigo de empresa.</div>
                    </div>
