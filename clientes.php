            ...
            <tr class="cli-row">
              ...
              <td data-label="Ações" class="text-end">
                <div class="d-inline-flex gap-1">
                  ...
                  <a class="btn btn-sm btn-outline-danger" href="/cliente_delete.php?id=<?= (int)$r['id'] ?>" onclick="return confirm('Confirma excluir (soft delete)?');" title="Excluir"><i class="bi bi-trash"></i></a>
                </div>
              </td>
            </tr>
